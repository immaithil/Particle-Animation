...
function getBack() {
    document.getElementById('contain').className = 'container';
    document.getElementById('back').className = 'back-hide';
    document.getElementById('canvas1').className = 'canvas-hide';
    document.getElementById('name').vlaue ="";
}
function show() {
    document.getElementById('canvas1').className = 'canvas-show';
    document.getElementById('contain').className = 'container-hide'
    document.getElementById('back').className = 'back-show';



    const ashi = document.getElementById('name').value;
    // var nam = ashi;
    // console.log('ram' + nam);
    //const name= prompt("Enter your first Name");
    ctx.fillStyle = 'white';
    ctx.font = '30px Verdana';
    ctx.fillText(ashi, 0, 40);
